...
function Demo() {
  ...
  const { data: districts, isLoading: loadingDistricts } = useDistricts(provinceCode?.value);
  const { data: subdistricts, isLoading: loadingSubdistricts } = useSubdistricts(districtCode?.value);
  const { data: villages, isLoading: loadingVillages } = useVillages(subdistrictCode?.value);
